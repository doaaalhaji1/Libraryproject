         ...
         <div class="container-fluid">
             ...
             <div class="collapse navbar-collapse" id="navbarNav">
                 <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block  ms-3">
                        <a href="{{route('revrese_books_data')}}" class="nav-link"> {{__('dash.Reserved_Books_Data')}}</a>
                    </li>
                </ul>
                <div class="navbar-item ms-auto me-0">
                <ul class="navbar-nav ">
                     <li class="nav-item">
                     ...
                     <li class="nav-item dropdown user-menu">
                         ...
                         <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end  ms-auto me-0">
